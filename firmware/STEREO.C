...
int val,*input;
unsigned FWERT=0x7f,REGISTER=0x50,GAIN=0x1,TAKT=0x06,OUT=0x300,
		...
		if(GAIN<0x07) 
		  {
		   ...
		   printf("GAIN FAKTOR ERH™HEN AUF : ");
		   printf("%s\n",gwerte[GAIN]);
		  }
...
printf("TASTE <3> FšR ABTASTRATE ERH™HEN, z.Z. ");
printf("%d us\n",ARATE/8);
printf("TASTE <4> FšR ABTASTRATE SENKEN, z.Z. ");
printf("%d us\n",ARATE/8);
printf("TASTE <+> FšR FILTERFREQUENZ ERH™HEN, z.Z. ");
printf("%s kHz\n",fwerte[FWERT]);
printf("TASTE <-> FšR FILTERFREQUENZ SENKEN, z.Z. ");
printf("%s kHz\n",fwerte[FWERT]);
printf("TASTE <p> FšR GAIN ERH™HUNG, z.Z. FAKTOR ");
printf("%s\n",gwerte[GAIN]);
printf("TASTE <m> FšR GAIN SENKEN, z.Z. FAKTOR ");
printf("%s\n",gwerte[GAIN]);
